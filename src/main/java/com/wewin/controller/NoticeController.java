...
public class NoticeController {
     ...
     * @return
     */
    @RequestMapping(value = "/notice/addnotice" ,method={RequestMethod.GET,RequestMethod.POST})
     ...
     * @return
     */
    @RequestMapping(value = "/notice/updatenotice" ,method={RequestMethod.GET,RequestMethod.POST})
     ...
     * 删除公告
     */
    @RequestMapping(value = "/noticedeletenotice" ,method={RequestMethod.GET,RequestMethod.POST})
     ...
     * 查找某个公告的详细内容
     */
    @RequestMapping(value = "/notice/findnotice" ,method={RequestMethod.GET,RequestMethod.POST})
     ...
     * 参加活动
     */
    @RequestMapping(value = "/notice/join_activity" ,method={RequestMethod.GET,RequestMethod.POST})
     ...
     * 查找某个公告的已读/已报名人
     */
    @RequestMapping(value = "/read/findreaded" ,method={RequestMethod.GET,RequestMethod.POST})
     ...
     * 查找某个公告的未读/未报名人
     */
    @RequestMapping(value = "/read/findunreaded" ,method={RequestMethod.GET,RequestMethod.POST})
     ...
     * 查找该用户发布的所有公告
     */
    @RequestMapping(value = "/notice/find_created_notices" ,method={RequestMethod.GET,RequestMethod.POST})
     ...
     * 查找该用户所有已读公告
     */
    @RequestMapping(value = "/notice/find_read_notices" ,method={RequestMethod.GET,RequestMethod.POST})
     ...
     * 查找该用户所有未读公告
     */
    @RequestMapping(value = "/notice/find_unread_notices" ,method={RequestMethod.GET,RequestMethod.POST})
     ...
     * @return
     */
    @RequestMapping(value = "/notice/test2" ,method={RequestMethod.GET,RequestMethod.POST})
     ...
     * 查找某个公告的详细内容
     */
    @RequestMapping(value = "/notice/test" ,method={RequestMethod.GET,RequestMethod.POST})
